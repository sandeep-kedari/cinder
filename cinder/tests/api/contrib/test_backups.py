...
class BackupsAPITestCase(test.TestCase):
    ...
    def test_list_backups_detail_xml(self):
        ...
        self.assertEqual('az1',
                         backup_detail.item(0).getAttribute(
                         'availability_zone'))
        self.assertEqual('volumebackups',
                         backup_detail.item(0).getAttribute(
                         'container'))
        ...
        self.assertEqual(0,
                         int(backup_detail.item(0).getAttribute(
                         'object_count')))
        self.assertEqual(0,
        ...
        self.assertEqual('az1',
                         backup_detail.item(1).getAttribute(
                         'availability_zone'))
        self.assertEqual('volumebackups',
        ...
        self.assertEqual(0,
                         int(backup_detail.item(1).getAttribute(
                         'object_count')))
        self.assertEqual(0,
        ...
        self.assertEqual('az1',
                         backup_detail.item(2).getAttribute(
                         'availability_zone'))
        self.assertEqual('volumebackups',
        ...
        self.assertEqual(0,
                         int(backup_detail.item(2).getAttribute(
                         'object_count')))
        self.assertEqual(0,
