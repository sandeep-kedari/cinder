...
class RequestTest(test.TestCase):
    ...
    def test_cache_and_retrieve_resources(self):
        ...
        self.assertEqual(request.cached_resource_by_id('r-0'), resources[0])
        self.assertEqual(request.cached_resource_by_id('r-1'), resources[1])
        self.assertEqual(request.cached_resource_by_id('r-2'), resources[2])
...
class ResourceTest(test.TestCase):
    ...
    def test_get_method_action_method(self):
        ...
        method, extensions = resource.get_method(None, 'action',
                                                 'application/xml',
                                                 '<fooAction>true</fooAction')
        self.assertEqual(method, controller.action)
