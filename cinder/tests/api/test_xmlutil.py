...
class SelectorTest(test.TestCase):
    ...
    def test_items_selector(self):
        ...
        for key, val in sel(self.obj_for_test):
            self.assertEqual(val, self.obj_for_test['test']['attrs'][key])
...
class TemplateElementTest(test.TestCase):
    ...
    def test_element_extend_children(self):
        ...
        for idx in range(len(elem)):
            self.assertEqual(elem[idx], children[idx])
    ...
    def test_apply_attrs(self):
        ...
        for k, v in elem.items():
            self.assertEqual(v, str(attrs[k].value))
    ...
    def test_apply_text(self):
        ...
        self.assertEqual(elem.text, str(tmpl_elem.text.value))
    ...
    def test__render(self):
        ...
        self.assertEqual(elem, parent[0])
    ...
    def test_render(self):
        ...
        self.assertEqual('foo', elems[0][1], 'foo')
    ...
    def test_subelement(self):
        ...
        self.assertEqual(1, len(parent))
        self.assertEqual(child, parent[0])
...
class TemplateTest(test.TestCase):
    ...
    def test_master_copy(self):
        ...
        self.assertEqual(copy.root, tmpl.root)
        self.assertEqual(copy.version, tmpl.version)
        self.assertEqual(id(copy.nsmap), id(tmpl.nsmap))
        self.assertNotEqual(id(tmpl.slaves), id(copy.slaves))
        self.assertEqual(len(copy.slaves), len(tmpl.slaves))
        self.assertEqual(copy.slaves[0], tmpl.slaves[0])
    ...
    def test__serialize(self):
        ...
        self.assertEqual(obj['test']['name'], result.get('name'))
...
class TemplateBuilderTest(test.TestCase):
    def test_master_template_builder(self):
        ...
        self.assertEqual(cached, MasterTemplateBuilder._tmpl)
        ...
        self.assertEqual(tmpl3, MasterTemplateBuilder._tmpl)
    ...
    def test_slave_template_builder(self):
        ...
        self.assertEqual(tmpl1, SlaveTemplateBuilder._tmpl)
